    ...
    <div className="confirm-page">
      ...
      <div className="confirm-container">
        ...
        <div className="confirm-notice">
          <p>この申し込みはまだ本予約ではありません。</p>
          <p>送信後、入力したメールアドレス宛に確認メールを送信します。</p>
          <p>確認リンクを30分以内にクリックすると、予約が確定します。</p>
        </div>

        <div className="confirm-warning">
          <p>※このアプリはポートフォリオ用のMVPです。</p>
          <p>
            バックエンドはRenderの無料プランで公開しているため、一定時間アクセスがない場合、サーバーが一時停止します。
          </p>
          <p>
            そのため「仮予約メールを送信する」ボタンを押した後、初回のみ30〜60秒ほど時間がかかる場合があります。
          </p>
          <p>画面が切り替わるまで、そのままお待ちください。</p>
        </div>
